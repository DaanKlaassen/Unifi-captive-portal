...
$noUser = isset($_GET['noUser']) && $_GET['noUser'] === 'true';
?>
...
<div class="container" style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
    ...
    <?php endif; ?>
    <div class="countdown select-none" id="countdown">
        Je wordt teruggestuurd over 10 seconden.
    </div>
    <div class="manual-close" style="display:none;" id="manual-close">
        <p>Het venster kan niet automatisch worden omgeleid. <br> <strong>Klik <a href="<?php echo $rootURL; ?>/"
                                                                                  class='link'>hier</a> om terug te gaan
                naar de home pagina.</strong></p>
    </div>
</div>
<div class="logo">
